...
import ps.edu.diyar.messaging.useCase.ViewSentMsgUseCase;
import ps.edu.diyar.studentInfo.useCase.GetCrsInfoUseCase;

public class ViewSentMsgAction
  extends Action
{
    ...
    throws Exception
  {
    ...
    inpt.add(termNo);
      ...
      System.out.println("  hete eesds "+ crsNo+crsClass+termNo);
    new ViewSentMsgUseCase().execute(inpt, request);   
