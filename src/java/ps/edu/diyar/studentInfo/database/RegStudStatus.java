  ...
  implements Serializable
{
  ...
  public RegStudStatus(String statusNo, String statusAName, String statusLName, String userId, Date timeStamp, String isActive, String notes)
  {
  ...
  public RegStudStatus() {}
  
  public RegStudStatus(String statusNo, String statusAName, String userId, Date timeStamp, String isActive)
  {
    this.statusNo = statusNo;
    this.statusAName = statusAName;
    this.userId = userId;
  ...
  {
    if (!(other instanceof RegStudStatus)) {
      return false;
    }
    RegStudStatus castOther = (RegStudStatus)other;
 ...
 * Qualified Name:     ps.edu.diyar.studentInfo.database.RegStudStatus
