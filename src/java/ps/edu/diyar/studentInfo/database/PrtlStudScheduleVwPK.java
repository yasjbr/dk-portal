...
public class PrtlStudScheduleVwPK
  implements Serializable
{
  ...
  public boolean equals(Object o)
  {
    ...
    PrtlStudScheduleVwPK that = (PrtlStudScheduleVwPK)o;
    if (this.classNo != null ? !this.classNo.equals(that.classNo) : that.classNo != null) {
      return false;
    }
    if (this.counter != null ? !this.counter.equals(that.counter) : that.counter != null) {
      return false;
    }
  ...
  public int hashCode()
  {
    ...
    result = 31 * result + (this.counter != null ? this.counter.hashCode() : 0);
    return result;
  }
}
 ...
 * Qualified Name:     ps.edu.diyar.studentInfo.database.PrtlStudScheduleVwPK
