 ...
 * @author Yaseen Jaber
 */
public class PrtlStudFtermCardDtlPK implements Serializable 
{
   private String studId;
   private String termNo; 
    private String finCode;

    public PrtlStudFtermCardDtlPK(String studId, String termNo, String finCode) {
        this.studId = studId;
        this.termNo = termNo;
        this.finCode = finCode;
    }

    public PrtlStudFtermCardDtlPK() {
    }
  ...
  {
    if (!(other instanceof PrtlStudFtermCardDtlPK)) {
      return false;
    }
    PrtlStudFtermCardDtlPK castOther = (PrtlStudFtermCardDtlPK)other;
