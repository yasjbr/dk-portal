 ...
 * @author Yaseen Jaber
 */
public class SasStudFtermCardDtlPK implements Serializable 
{
   private String studId;
   private String termNo; 
    private String finCode;

    public SasStudFtermCardDtlPK(String studId, String termNo, String finCode) {
        this.studId = studId;
        this.termNo = termNo;
        this.finCode = finCode;
    }

    public SasStudFtermCardDtlPK() {
    }
  ...
  {
    if (!(other instanceof SasStudFtermCardDtlPK)) {
      return false;
    }
    SasStudFtermCardDtlPK castOther = (SasStudFtermCardDtlPK)other;
