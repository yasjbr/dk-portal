...
public class TutorsDeptListUseCase
  implements ComponentUseCase
{
  private static Logger logger = Logger.getLogger(TutorsDeptListUseCase.class);
    ...
    throws HibernateException
  {
    ...
    try
    {
      ...
      retList = cmp.getList("dptMstr.getTutorsDeptList", new Object[] { dptNo });
    }
 ...
 * Qualified Name:     ps.edu.diyar.deptMaster.usecase.TutorsDeptListUseCase
