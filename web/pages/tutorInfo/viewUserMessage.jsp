...
<script>
function deleteMessage(msgId,termNo,crsNo,crsClass)
{
  if(!msgId)
   {
   ...
   else
   {
     ...
     {
         parent.location="/tutor/deleteMsg.do?deletedValue="+msgId+"&crsNo="+crsNo+"&crsClass="+crsClass+"&termNo="+termNo+"&.rv=<%=Randomizer.shortRandom()%>";
...
{
      parent.location="/tutor/createUserMessages.do?msgId="+msgId+"&crsNo="+crsNo+"&crsClass="+crsClass+"&termNo="+termNo+"&senderId="+<%=request.getParameter("senderId")%>+"&.rv=<%=Randomizer.shortRandom()%>";
 }
             ...
             <td>&nbsp;&nbsp;</td>
              ...
              <td align="right"  width="50%" class="noprint">
               ...
               <a class=qou href="javascript:window.print()">
                ...
                <a class=qou href="javascript:deleteMessage('<bean:write name="messages" property="comp_id.msgId"/>','<bean:write name="messages" property="termNo"/>','<bean:write name="messages" property="crsNo"/>','<bean:write name="messages" property="classNo"/>')">
