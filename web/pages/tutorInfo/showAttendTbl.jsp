        ...
        <table width="100%" border="0">
          <tr>
           <td width="100%" valign="top">
             <br>
            <div align="right" class="centerpage"> حضور الطلية</div>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0"  >
                    <tr>
                     ...
                     <% int i = 0; %>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr class="tabheader">
                            <td width="30%" height="17" class="borderTopLeftBigColor"><div align="center">جدول حضور الطلبة</div></td>
                         ...
                         <%  if (i%2 == 0) { %>
                          ...
                          <%}%>
                            <td class="qou"><div align="center">
                                <a target="_blank" href="../../tutor/studListAttendReport?.rv=<%=Randomizer.shortRandom()%>&classNo=<bean:write name="TermSchedule" property="classNo"/>&crsNo=<bean:write name="TermSchedule" property="courseNo"/>&termNo=<bean:write name="TermSchedule" property="termNo"/> " class="qou">
                                عرض</a></div>
                            </td>
