...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderRoundedClearColor" bgcolor="#f38e00">
                          <tr class="tabheader">
                             <td  width="10%" ><div align="right">اللقاءات</div></td>
                            <td  width="10%" ><div align="right">الشعب</div></td>
                            <td  width="55%" ><div align="right">الاسم</div></td>
                     ...
                     <logic:iterate id="tutDptList" name="tutDptList" >
                         <%  if (i%2 == 0) { %>
                          ...
                          <%}%>
                            <td class="qou"><div align="right"><a href="/deptMstr/showDeptTutorTermSchedule.do?tutNo=<bean:write name="tutDptList" property="value"/>&.rv=<%= Randomizer.shortRandom()%>">عرض</a>  </div></td>                        
                            <td class="qou"><div align="right"><a href="/deptMstr/tutCrsList.do?tutNo=<bean:write name="tutDptList" property="value"/>&.rv=<%= Randomizer.shortRandom()%>">عرض</a>  </div></td>
