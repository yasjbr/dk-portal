...
<html:form action="marksApproveCheck.do" method="post" >
            ...
            <tr>
              <td width="100%" valign="top">
                      ...
                      <logic:present name="studentListForCourse">
                          <div align="right"><br/>
                           ...
                           <logic:iterate id="studentListForCourse" name="studentListForCourse" >
                                ...
                                <input type="text"   readonly  name="m<%=x%>" class="readonlyInputFieldSmaller" tabindex="<%=x%>" value='<bean:write name="studentListForCourse" property="crsMark"/>'>
                                 </div></td>
				...
				<div align="center">
                     ...
                     <input type="button" value="  عودة  " class="enter" onclick="javaScript:parent.location = '/deptMstr/tutCrsList.do?tutNo=<%=request.getParameter("empNo")%>&.rv=<%= Randomizer.shortRandom()%>'">&nbsp;
                   </div>
                     </logic:present>
