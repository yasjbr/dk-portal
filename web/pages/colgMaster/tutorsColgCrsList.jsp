                     ...
                     <% int i = 0; %>
                         ...
                         <logic:present name="tutInfo">
                             ...
                             <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderRoundedLightColor">
                               <tr  >
                                 <td width="32%" class="qou" ><div align="right"><bean:write name="tutInfo" property="empNo" />&nbsp;&nbsp;</div></td>
                                 <td width="17%" class="tabheader"><div align="center" class="centerpage">الرقم:</div></td>
                                 <td width="32%" class="qou"  ><div align="right"><bean:write name="tutInfo" property="tutorAName" />&nbsp;&nbsp;</div></td>
                                 <td width="19%" class="tabheader"><div align="center" class="centerpage">&nbsp;&nbsp;<bean:message key="studentHeader.name"/>:</div></td>
                               </tr>
                             </table>
                                 <br/>
                             </logic:iterate>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderRoundedClearColor">
                          <tr class="tabheader">
                            <td width="40%" height="17" class="borderTopLeftBigColor"><div align="center">العلامات</div></td>
                         ...
                         <%  if (i%2 == 0) { %>
                          ...
                          <%}%>
                            <td class="qou"><div align="center">
                                <a href="../../colgMstr/marksApproveDptColg.do?.rv=<%=Randomizer.shortRandom()%>&empNo=<%=request.getParameter("tutNo")%>&classNo=<bean:write name="TermSchedule" property="classNo"/>&crsNo=<bean:write name="TermSchedule" property="courseNo"/>&crsSeq=&termNo=<bean:write name="TermSchedule" property="termNo"/> " class="qou">
                               عرض</a></div>
                            </td>
                      ...
                      <table width="100%" border="1" cellspacing="0" cellpadding="0" class="border" bordercolor="#4A6D8C">
                        <tr bgcolor="#EAF0F4" class="centerpage">
                          <td width="99%"><div align="center">&nbsp;  No Avaliable Data </div></td>
                           ...
                           <br/>
                          <input type="button" value="  عودة  " class="enter" onclick="javaScript:parent.location = '/colgMstr/tutorsDeptcolgList.do?.rv=<%= Randomizer.shortRandom()%>&deptNo=<%=(String)request.getSession().getAttribute("browseDept")%>'">&nbsp;
