   ...
   function wrkOtherFun(wrkOthVal)
   {
    ...
    function chngWrkStatus()
    {
        ...
        if(wrk_value == 'Y')
        {
            ...
            document.srvyWorkDetailForm.wrkReason.className = 'largeInputView';
            document.srvyWorkDetailForm.wrkReason.value = ' ';
            ...
            document.srvyWorkDetailForm.wrkReason.readOnly  = true;
      ...
      <td>
             <table width="95%" align="center" class="qou" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr class="tableRowClearColor">
                    ...
                    <td align="right" colspan="2" class="qou9BoldRtl">4.2      عمل الوالدين / الأخوة / الأخوات</td>
                </tr> 
                <tr class="tableRowClearColor">
                    <td align="right" class="qouRtl"  valign="bottom" colspan="4" >
                        <html:radio property="isWork" tabindex="<%=String.valueOf(tabindex++)%>"   onclick="chngWrkStatus()"  value="Y"    /> يعمل
                        &nbsp;
                        <html:radio property="isWork" tabindex="<%=String.valueOf(tabindex++)%>"   onclick="chngWrkStatus()"    value="N"    /> لا يعمل
                        &nbsp;
                        <html:radio property="isWork" tabindex="<%=String.valueOf(tabindex++)%>"   onclick="chngWrkStatus()"    value="R"    /> متقاعد
                        &nbsp;
                        <html:radio property="isWork" tabindex="<%=String.valueOf(tabindex++)%>"   onclick="chngWrkStatus()"    value="D"    /> متوفٍ
                        &nbsp;
                    </td>
                    <td align="right" colspan="2" class="qou9BoldRtl">4.2.1 	الوالد:</td>
                </tr>
                <tr>
                    <td align="right" class="qouRtl" colspan="6">إذا كان الوالد يعمل، فاذكر:</td>
                </tr>
                <tr>
                ...
                <tr><td colspan="6" height="4"></td></tr>
                 <tr>
                     <td   align="right">
                       <html:text   property="wrkReason"  maxlength="100" styleClass="largeInput" tabindex="<%=String.valueOf(tabindex++)%>" />
                     </td>
                     <td  align="right" class="qouRtl" >إذا كان الوالد لا يعمل، أذكر السبب:</td>
                     <td   align="right" class="qouRtl"  valign="middle"  >  <lu><li></li></lu>   </td>
                     <td   align="right">
                      <html:select property="wrkSalary" styleClass="largeInput" tabindex="<%=String.valueOf(tabindex++)%>">
                         <html:option value="*">اختر</html:option>
                         <html:option value="1">أقل من 500</html:option>
                         <html:option value="2">500 - 999</html:option>
                         <html:option value="3">1000 - 1449</html:option>
                         <html:option value="4">1500 - 1999</html:option>
                         <html:option value="5">2000 - 2449</html:option>
                         <html:option value="6">2500 وأكثر </html:option>
                      </html:select>
                     </td>
