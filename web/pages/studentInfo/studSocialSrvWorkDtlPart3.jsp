             ...
             <table width="95%" align="center" class="qou" border="0" cellpadding="0" cellspacing="0">
                <tr class="tableRowClearColor">
                    <td align="right" class="qouRtl"  valign="bottom" colspan="4" >
                        <html:radio property="isWork" tabindex="<%=String.valueOf(tabindex++)%>"   onclick="chngWrkStatus()"  value="Y"    /> تعمل
                        &nbsp;
                        <html:radio property="isWork" tabindex="<%=String.valueOf(tabindex++)%>"   onclick="chngWrkStatus()"    value="N"    /> لا تعمل
                        &nbsp;
                        <html:radio property="isWork" tabindex="<%=String.valueOf(tabindex++)%>"   onclick="chngWrkStatus()"    value="R"    /> متقاعدة
                        &nbsp;
                        <html:radio property="isWork" tabindex="<%=String.valueOf(tabindex++)%>"   onclick="chngWrkStatus()"    value="D"    /> متوفية
                        &nbsp;
                    </td>
                    <td align="right" colspan="2" class="qou9BoldRtl">4.2.2 	الوالدة:</td>
                </tr>
                <tr>
                    <td align="right" class="qouRtl" colspan="6">إذا كانت الوالدة تعمل، فاذكر:</td>
                </tr>
                <tr>
