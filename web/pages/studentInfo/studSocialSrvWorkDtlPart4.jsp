             ...
             <table width="95%" align="center" class="qou" border="0" cellpadding="0" cellspacing="0">
                <tr class="tableRowClearColor">
                    <td align="right" class="qouRtl"  valign="bottom" colspan="4" >
                        ...
                        &nbsp;
                        <html:radio property="isWork" tabindex="<%=String.valueOf(tabindex++)%>"   onclick="chngWrkStatus()"    value="D"    />متوفي
                        &nbsp;
                    </td>
                    <td align="right" colspan="2" class="qou9BoldRtl">4.2.3  	الزوج/الزوجة:   </td>
                </tr>
                <tr>
                    <td align="right" class="qouRtl" colspan="6">إذا كان الزوج/الزوجة يعمل، فاذكر:</td>
                </tr>
                <tr>
