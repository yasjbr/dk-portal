...
<script type="text/javascript">
    ...
    function editRecord(relativeAName_p,enroleDate_p,schoolNo_p,schoolType_p,yearlyCost_p,donarAName_p, academicSeq_p)
    {
        ...
        document.studSocialSurveyAcadDtlForm.schoolNo.value = schoolNo_p;
        document.studSocialSurveyAcadDtlForm.schoolType.value = schoolType_p;
...
<TABLE cellSpacing=0 cellPadding=0 width="966" align=center border=0 class="qou" dir="ltr" >
  <TBODY    >
    <tr>
      <td>
          ...
          <tr>
            ...
            <td width="50%" align="right" >
              <div class="textDate" align="right" dir="rtl">3.2  هل لديك أخوة/أخوات يدرسون في المدارس؟</div>
            </td>
          </tr>
          </table>
           <div id="dataDiv">
                     ...
                     <% int i = 0; %>
                       ...
                       <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderRoundedClearColor" bgcolor="#f38e00">
                          <tr class="tabheader">
                            <td width="10%">&nbsp;</td>
                            <td width="15%"><div align="center">من يسدد المصاريف الجامعية  (العائلة، مصادر أخرى)</div></td>
                            <td width="11%"><div align="center">التكلفة السنوية بالشيكل</div></td>
                            <td width="5%"><div align="center">مدرسة حكومية/خاصة</div></td>
                            <td width="20%"><div align="center">اسم المدرسة</div></td>
                            <td width="5%"><div align="center">تاريخ الالتحاق بالمدرسة</div></td>
                            <td width="20%"><div align="center">الاسم</div></td>
                          </tr>
                     <logic:iterate id="srvAcadDtl" name="srvAcadDtl" >
                         <%  if (i%2 == 0) { %>
                          ...
                          <%}%>
                            ...
                            &nbsp;
                            <a href="javascript:showHideDiv('addEditDataDiv','dataDiv','2'); editRecord('<bean:write name="srvAcadDtl" property="relativeAName"/>','<bean:write name="srvAcadDtl" property="enroleDate" format="dd/MM/yyyy"/>','<bean:write name="srvAcadDtl" property="schoolNo"/>','<bean:write name="srvAcadDtl" property="schoolType"/>','<bean:write name="srvAcadDtl" property="yearlyCost"/>','<bean:write name="srvAcadDtl" property="donarAName"   />', '<bean:write name="srvAcadDtl" property="comp_id.academicSeq"/>'); " title="تعديل"><img src="/pages/resources/images/recEdit.gif" border="0" alt="تعديل" width="20" height="20"/></a>
                            &nbsp;
                            </td>
                            ...
                            <td class="qou"><div align="center">
                                <logic:equal name="srvAcadDtl" property="schoolType" value="1"><b>حكومية</b></logic:equal>
                                <logic:equal name="srvAcadDtl" property="schoolType" value="2"><b>خاصة</b></logic:equal>
                             </div></td>
                            <td class="qou"><div align="center"><bean:write name="srvAcadDtl" property="schoolAName"/></div></td>
     ...
     <html:hidden property="relativeType" value="2"  />
          ...
          <div id="addEditDataDiv" style="display:none;">
            ...
            <table width="95%" align="center" class="borderRoundedClearColor" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr class="tableRowLightColor">
                    ...
                    <td align="right" width="35%" class="qou9Bold">تاريخ الالتحاق بالمدرسة</td>
                ...
                <tr>
                    <td align="right" ><html:select property="schoolNo"  tabindex="<%=String.valueOf(tabindex++)%>" styleClass="largeInput"  > <html:option value="*">اختر</html:option>  <logic:present name="schoolList"><html:options collection="schoolList" property="value"  labelProperty="label"/></logic:present></html:select></td>
                    <td align="right" class="qou9Bold">اسم المدرسة</td>
                    <td align="right" >
                        <html:select property="schoolType"  tabindex="<%=String.valueOf(tabindex+2)%>" styleClass="largeInput">
                              <html:option value="1">حكومية</html:option>
                              <html:option value="2">خاصة</html:option>
                        </html:select>
                     <td align="right" class="qou9Bold" >مدرسة حكومية/خاصة</td>
                </tr>
                <tr class="tableRowLightColor">
