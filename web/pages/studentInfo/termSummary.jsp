...
<table align="left" width="99%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td width="99%"  valign="top">
				...
				<br>
<!-- here -->
           <form name = "form1" action="../../student/showSelectedTermSummary.do?.rv=<%=Randomizer.shortRandom()%>" method="post">
                  ...
                  <TABLE border=0 cellPadding=0 cellSpacing=0 height=24 width="99%">
                    ...
                    <TR   height=24 vAlign=center>
                      <TD height=24 width="24%">
                       ...
                       <qou:TermListNavigator pageType="student/showSelectedTermSummary.do"/>
                    ...
                    <tr>
                      ...
                      <logic:present name="termCourseSummary">
                       ...
                       <logic:iterate id="TermCourse" name="termCourseSummary" >
                          ...
                          <logic:present name="Error"> 
                           <td><div align="center" class="qou"> </div></td>
                          <td height="14"><div align="center" class="qou"> </div></td>
                          </logic:present>
                      ...
                      <td height="50" ><table border="0"  width="100%" height="50"   cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td class="borderBottomLeftLightColor"><div align="center" class="qou"></div></td>
                           <logic:present name="Error">
                          <td class="tableRowLightColor"><div align="center" class="qou"> </div></td>
                          <td class="tableRowLightColor"><div align="center" class="qou"> </div></td>
                          </logic:present >
