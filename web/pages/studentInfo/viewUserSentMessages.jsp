      ...
      <TD width="99%" >
        <div align="center">
                ...
                <table width="100%">
                 <tr>
                  <TD width="60%" class="qou">
                    <pagination:pagination list="<%= messageCount %>" pagesize="10" requestUri="../../student/viewUserMessages.do?.rv=<%=Randomizer.shortRandom()%>"/>
                  </td>
                  <TD width="40%" class="qou">
			      <div class="centerpage" align="right"><input type="button" value="  ارسال رسالة جديدة  " class="enter" onclick="javaScript:parent.location = '/student/createUserMessages.do?crsNo=<%=request.getAttribute("crsNo")%>&crsClass=<%=request.getAttribute("crsClass")%>&termNo=<%=request.getAttribute("termNo")%>&.rv=<%=Randomizer.shortRandom()%>'">&nbsp;  </div>
                  </td>
                 </tr>
                </table>
                   ...
                   <td height="40" align="center" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <logic:present name="msgList">
                       ...
                       <tr valign="top" >
                        <td class="tabheader" width="10%"><div align="center">الحالة</div></td>
  					    <td class="tabheader" width="29%"><div align="center">المرسل اليه</div></td>
                      ...
                      <% int rowNumber=0;%>
                       ...
                       <form action="/student/createStudentMessage.do?.rv=<%=Randomizer.shortRandom()%>&rowNumber=<%=rowNumber%>" name="<%=rowNumber%>" method="post" target="_blank">
					      <%  if (rowNumber%2 == 0) { %>
                         ...
                         <td class="qou" ><div align="center"><bean:write name="msgList" property="recipientName"/> </div></td>
                         ...
                         <td class="qou" height="10"><div align="right">
                             ...
                             <b>
                             <a href="../../student/viewUserMessagesDetails.do?msgId=<bean:write name="msgList" property="msgId"/>&senderId=<bean:write name="msgList" property="senderId"/>&read=<bean:write name="msgList" property="viewed"/>&row=<%=rowNumber%>&mt=<%=request.getParameter("tmt")%>" class="qou"   ><bean:write name="msgList" property="msgTitle" filter="false"/></a>
                             </b>
                             </logic:equal>
                             <logic:notEqual name="msgList" property="viewed" value="F">
                             <a href="../../student/viewUserMessagesDetails.do?msgId=<bean:write name="msgList" property="msgId"/>&senderId=<bean:write name="msgList" property="senderId"/>&read=<bean:write name="msgList" property="viewed"/>&.rv=<%=Randomizer.shortRandom()%>" class="qou"  ><bean:write name="msgList" property="msgTitle" filter="false"/></a>
                             </logic:notEqual>
                         </div></td>
          ...
          <table border="0" cellpadding="0" cellspacing="0"  >
           <form action="/student/deleteSentMsg.do?.rv=<%=Randomizer.shortRandom()%>" name="mainForm" method="post">
            <tr valign="top" >
             <td height="20" valign="top"> <div align="right">
              ...
              <br/>
              <div align="center">
              <input type="button" value="  عودة  " class="enter" onclick="javaScript:parent.location = '/student/showMessages.do?.rv=<%=Randomizer.shortRandom()%>'">&nbsp;
              </div>
          </td>
          </tr>
          </table>
